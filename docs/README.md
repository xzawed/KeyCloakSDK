...
|---|---|---|---|
| [문서 IA 재설계 SDD](superpowers/plans/doc-ia-sdd.md) | 2026-08-19 | 완료 | 문서 354KB·소스 243파일·집행장치 55종을 4개 에이전트로 훑어 확정한 **결함 목록과 그 우선순위**. 문서별 **가드 결합도**(README 55 ↔ playbook 0)와 그것으로 산정한 PR 분할 순서. 릴리스 런북이 정식 게시 뒤에도 "정식 없음"이라 말한 P0와 그것을 놓친 앵커의 구조적 이유. 사실별 **단일 소유자 표**와, 언어를 1차 축으로 두면 안 되는 근거. |
