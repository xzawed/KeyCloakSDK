...
- [ ] `doc-audit-batch3-fixes-outstanding` **[M/M · 신규 2026-09-06]** 배치 3 발견 50건 중 **13건 미수정**(남은 것: `rejected.md` 8 · `process.md` 3 · `CONTRACT.md` 2 — ⚠️ 셋 다 예산 여유 <50B 이거나 가드가 기각된 자리다). 닫힌 37 = rules 10(#423) · 계수 3(#425) · 플레이북 11(#426, 재스캔 1 포함) · 지도 7 + 하네스 9(#429). 방법·전제·기각 판정은 [문서 사실에 오라클 붙이기](2026-09-06-doc-fact-oracles.md)가 소유한다
