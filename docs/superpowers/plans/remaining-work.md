...
- [ ] `doc-audit-batch3-fixes-outstanding` **[M/M · 신규 2026-09-06]** 배치 3 발견 50건 중 **27건 미수정**(남은 것: `rejected.md` 8 · `docs/README.md` 5 · `install/README.md` 5 · `harness/README.md` 4 · `process.md` 3 · `CONTRACT.md` 2). 닫힌 23 = rules 10(#423) · 계수 3(#425) · 플레이북 10(#426). 방법·전제·기각 판정은 [문서 사실에 오라클 붙이기](2026-09-06-doc-fact-oracles.md)가 소유한다
