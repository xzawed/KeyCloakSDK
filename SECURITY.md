...
This project is **pre-1.0**. Five SDKs have shipped a first **release candidate** to
a public registry — PHP (`0.1.0-rc.1`, Packagist), Python (`0.1.0rc1`, PyPI),
.NET (`0.1.0-rc.1`, NuGet), Rust (`0.1.0-rc.1`, crates.io) and Ruby
(`0.1.0.rc1`, RubyGems). The other four
(Java, Node, Go, Kotlin) are at `0.1.0` (Java: `0.1.0-SNAPSHOT`) and are not
