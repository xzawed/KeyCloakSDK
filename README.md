...
>
> ⚠️ **First release candidates are live for PHP, Python, .NET, Rust, Ruby and Node; the other three languages are not on a registry yet** — every release is human-gated. Everything below runs today from a clone: see [Try it today](#try-it-today).
