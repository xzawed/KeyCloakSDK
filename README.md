...
>
> ⚠️ **First release candidates are live for PHP, Python, .NET, Rust, Ruby, Node, Java and Kotlin; the other language is not on a registry yet** — every release is human-gated. Everything below runs today from a clone: see [Try it today](#try-it-today).
