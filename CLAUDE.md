...
- ⚠️ **(C#) `Raw`로도 도달 불가능한 admin 갭 3건(realms.list·realms.update·roles.update) — 아홉 SDK 중 유일.** 상세: `.claude/rules/dotnet.md`
- ⚠️ **(Rust) `search_users`가 max=20을 하드코딩해 결과가 조용히 잘린다.** 상세: `.claude/rules/rust.md`
